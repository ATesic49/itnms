			...
			<Container className="py-16 lg:pt-10 md:py-20 lg:py-28">
				<div className="grid items-center gap-12 lg:grid-cols-[1fr_0.95fr] lg:gap-16">
					...
					<div>
						...
						<dl className="grid max-w-xl grid-cols-3 gap-6 pt-8 mt-10 border-t capitqalize border-stone-200 sm:grid-cols-4">
							<HeroStat
								value="75+"
							...
							<HeroStat
								value="200+"
								label="broj naučnih publikacija"
							/>
							<HeroStat
								value="15%"
								label="Izvrsnih istraživača"
							/>
						</dl>
					</div>
