...
export function CompactProjectCard({
	...
	return (
		<article className="group rounded-xl border border-stone-200 bg-white p-6 shadow-sm transition hover:border-institute-300 hover:shadow-md">
			<div className="flex flex-col gap-5">
				...
				<a
					href={projectUrl}
					className="inline-flex items-center gap-2 self-start text-sm font-semibold text-institute-700 transition hover:text-institute-900"
				>
