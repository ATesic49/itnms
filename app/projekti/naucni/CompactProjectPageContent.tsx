...
export function ScientificProjectCard({ project }: ScientificProjectCardProps) {
	return (
		<article className="overflow-hidden transition bg-white border shadow-sm rounded-2xl border-stone-200 hover:border-institute-300 hover:shadow-md">
			<div className="grid gird-cols-2 lg:grid-cols-[1fr_300px]">
				<div className="p-6 md:p-8">
					...
					<section className="mt-6">
						...
						<p className="mt-3 text-sm leading-7 text-stone-600 md:text-base line-clamp-3">
							{project.apstrakt}
						</p>
					</section>
					<a
						href={"/projekti/naucni?title=" + project.projectName}
						target="_blank"
						rel="noreferrer"
						className="inline-flex items-center justify-end w-full gap-2 px-5 mt-2 text-sm font-semibold transition rounded-md text-institute-800 border-institute-800 hover:text-institute-900 hover:underline underline-offset-4 text-end "
					>
						Više o projektu
						<ExternalLink
							className="w-4 h-4"
					...
					<div className="flex items-center justify-center gap-2 w-fit">
						...
						{/* <a
							...
							target="_blank"
							rel="noreferrer"
							className="inline-flex items-center gap-2 px-5 py-3 mt-8 text-sm font-semibold transition rounded-md text-institute-800 border-institute-800 hover:text-institute-900 hover:underline underline-offset-4"
						>
							Više o projektu
							<ExternalLink
								className="w-4 h-4"
				...
				<aside className="p-6 border-t border-stone-200 bg-stone-50 md:p-8 lg:border-l lg:border-t-0">
					...
					<ProjectInfo
						...
						label="Finansijer"
					>
						<p className="line-clamp-2">{project.finansijer}</p>
					</ProjectInfo>
					...
					<ProjectInfo
						...
						label="NIO učesnici"
					>
						<ul className="space-y-2 line-clamp-2 ">
